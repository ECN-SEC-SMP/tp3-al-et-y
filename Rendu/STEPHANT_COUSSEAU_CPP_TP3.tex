...
Ce troisième TP à pour objectif de nous faire travailler une nouvelle notion en C++ : les templates.
...
Enfin, nous spécialisrons nos classe, puis créerons une liste de forme.
...
Dans cette seconde partie, nous allons créer une classe afin de manupiler une forme, constituée de points. 
...
On veut ici réaliser des formes géométriques concrètes. C'est à dire une forme consituée de points, avec une longueur et une hauteur donnée.
On va créer ici deux classe (rectangle et carré, avec notion d'héritage pour cette dernière).
...
Nous avons également renforcé notre compréhension des concepts liés au classes, ainsi que du langage C++ d'une manière générale.
Ces notions nous serons importantes pour l'avenir, notamment dans le cadre du projet de fin de module à venir.
\end{document}